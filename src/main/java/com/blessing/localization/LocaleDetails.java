...
public class LocaleDetails {
    public static void main(String args[]) {
        ...
        System.out.printf("The default language code is %s and the name is %s %s %n", defaultLocale.getLanguage(),
                defaultLocale.getDisplayLanguage(), defaultLocale.getScript());
